...
const Edit = () => {
    ...
    // data
      ...
      const handleYearUpdate = (id) => {
        ...
        axios.put(`${API_URL}/updateyear/${id}`, { year }, { headers: { 'Content-Type': 'application/json' } }).then(function (response) {
          if (response.data.success === true) {
            toast.success(response.data.message);
      ...
      const handleClassUpdate = (id) => {
        ...
        axios.put(`${API_URL}/updateclass/${id}`, { className }, { headers: { 'Content-Type': 'application/json' } }).then(function (response) {
          if (response.data.success === true) {
            toast.success(response.data.message);
          ...
          .catch(response => toast.error('Class already exists'))
      }

      const handleMediumUpdate = (id) => {
        if (!medium ) {
          return toast.error("Please fill in all the fields!")
        }
    
        axios.put(`${API_URL}/updatemedium/${id}`, { medium }, { headers: { 'Content-Type': 'application/json' } }).then(function (response) {
          if (response.data.success === true) {
            toast.success(response.data.message);
            setEditMediumModal(false)
            setMedium('');
            axios.get(`${API_URL}/medium`)
              .then(response => {
                setMediumList(response.data)
      ...
      const handleVersionUpdate = (id) => {
        ...
        axios.put(`${API_URL}/updateversion/${id}`, { version }, { headers: { 'Content-Type': 'application/json' } }).then(function (response) {
          if (response.data.success === true) {
            toast.success(response.data.message);
...
<ToastContainer
      ...
      />
      {/* edit Modals */}
      <Modal handleSubmit={handleYearUpdate} modal={edityearModal} setModal={setEditYearModal} value={year} setValue={setYear} h1Value='বছর আপডেট' btnValue='আপডেট' id={id}></Modal>

      <Modal handleSubmit={handleClassUpdate} modal={editclassModal} setModal={setEditClassModal} value={className} setValue={setClassName} h1Value='শ্রেণি আপডেট' btnValue='আপডেট' id={id}></Modal>

      <Modal handleSubmit={handleMediumUpdate} modal={editmediumModal} setModal={setEditMediumModal} value={medium} setValue={setMedium} h1Value='মাধ্যম আপডেট' btnValue='আপডেট' id={id}></Modal>

      <Modal handleSubmit={handleVersionUpdate} modal={editversionModal} setModal={setEditVersionModal} value={version} setValue={setVersion} h1Value='ভাষা আপডেট' btnValue='আপডেট' id={id}></Modal>
        ...
        <div className="flex relative m-auto justify-center self-center p-4 w-full max-w-md max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              ...
              <button type="button" onClick={() => setYearModal(false)} className="text-gray-400 bg-transparent hover:bg-white hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
        ...
        <div className="flex relative m-auto justify-center self-center p-4 w-full max-w-md max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              ...
              <button type="button" onClick={() => setClassModal(false)} className="text-gray-400 bg-transparent hover:bg-white hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
                <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                </svg>
                <span className="sr-only">Close</span>
        ...
        <div className="flex relative m-auto justify-center self-center p-4 w-full max-w-md max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              ...
              <button type="button" onClick={() => setMediumModal(false)} className="text-gray-400 bg-transparent hover:bg-white hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
                <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                </svg>
                <span className="sr-only">Close</span>
        ...
        <div className="flex relative m-auto justify-center self-center p-4 w-full max-w-md max-h-full">
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
              ...
              <button type="button" onClick={() => setVersionModal(false)} className="text-gray-400 bg-transparent hover:bg-white hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="crud-modal">
                <svg className="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                </svg>
                <span className="sr-only">Close</span>
        ...
        <div className='bg-white p-4 rounded-xl'>
            <button data-modal-target="crud-modal" onClick={() => setYearModal(true)} data-modal-toggle="crud-modal" className="flex items-center justify-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800" type="button">
                ...
                {yearlist.map((item, index) => (
                 <div className='bg-gray-100 my-2 rounded-2xl px-4 py-2 flex justify-between items-center' key={index}>
                 <p>{item.year}  </p> 
